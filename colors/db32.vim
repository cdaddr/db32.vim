...
hi MatchParen     ctermfg=16 ctermbg=215 cterm=none guifg=#ffffff guibg=#847e87 gui=none

" Search
hi Search         ctermfg=16 ctermbg=179 cterm=none guifg=#ffffff guibg=#08080d gui=underline
hi IncSearch      ctermfg=231 ctermbg=168 cterm=none guifg=#fbf236 guibg=#08080d gui=underline
...
" Misc
hi SpecialKey     ctermfg=114 ctermbg=235 cterm=none guifg=#323c39 guibg=#11101a gui=none
hi NonText        ctermfg=244 ctermbg=235 cterm=none guifg=#323c39 guibg=#11101a gui=none
